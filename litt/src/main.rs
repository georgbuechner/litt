...
use interactive_search::InteractiveSearchInput::*;
use interactive_search::InteractiveSearchState::*;
use interactive_search::SearchOptionUpdate::*;
use crossterm::{
    event::{self, Event, KeyCode},
    execute, terminal,
};
use interactive_search::{InteractiveSearch, InteractiveSearchInput};
